...
# Search for .env file
# Learned from: https://www.youtube.com/watch?v=ecshCQU6X2U&ab_channel=StripeDevelopers
...
SECRET_KEY = 'django-insecure-$t54re*ukpji((f2rgr8&4(u)^2pqx$ruva6278hw$u7386t!$'
...
AUTH_USER_MODEL = "gridsquid.User"
